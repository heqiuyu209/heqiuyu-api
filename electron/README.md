# heqiuyu Electron Desktop App

This directory contains the Electron wrapper for heqiuyu, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., heqiuyu-api-macos)
cp ../heqiuyu-api-macos ../heqiuyu-api
```
...
- Store database in `../data/heqiuyu-api.db`
...
### Database Location
- **Development**: `../data/heqiuyu-api.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/heqiuyu/data/`
  - Windows: `%APPDATA%/heqiuyu/data/`
  - Linux: `~/.config/heqiuyu/data/`
