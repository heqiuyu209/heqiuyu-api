...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-heqiuyu-api-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-heqiuyu-api-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-heqiuyu-api-container') return true;
      return (
