...
本文档提供使用宝塔面板 Docker 功能部署 heqiuyu 的图文教程。
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/heqiuyu-api`
