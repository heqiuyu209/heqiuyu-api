...
func OaiStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.HeqiuyuError) {
...
func OpenaiHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.HeqiuyuError) {
	defer service.CloseResponseBodyGracefully(resp)
...
func OpenaiRealtimeHandler(c *gin.Context, info *relaycommon.RelayInfo) (*types.HeqiuyuError, *dto.RealtimeUsage) {
...
func OpenaiHandlerWithUsage(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.HeqiuyuError) {
	defer service.CloseResponseBodyGracefully(resp)
