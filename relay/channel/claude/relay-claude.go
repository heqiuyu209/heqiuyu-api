...
import (
	...
	"github.com/heqiuyu/heqiuyu-api/relay/channel/openrouter"
	relaycommon "github.com/heqiuyu/heqiuyu-api/relay/common"
	"github.com/heqiuyu/heqiuyu-api/relay/helper"
	"github.com/heqiuyu/heqiuyu-api/relay/reasonmap"
...
func HandleStreamResponseData(c *gin.Context, info *relaycommon.RelayInfo, claudeInfo *ClaudeResponseInfo, data string) *types.HeqiuyuError {
...
func ClaudeStreamHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.HeqiuyuError) {
...
func HandleClaudeResponseData(c *gin.Context, info *relaycommon.RelayInfo, claudeInfo *ClaudeResponseInfo, httpResp *http.Response, data []byte) *types.HeqiuyuError {
	var claudeResponse dto.ClaudeResponse
...
func ClaudeHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.HeqiuyuError) {
