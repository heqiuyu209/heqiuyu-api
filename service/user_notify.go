	...
	if system_setting.EnableWorker() {
		...
		workerReq := &WorkerRequest{
			...
			Headers: map[string]string{
				"User-Agent": "heqiuyu-Bark-Notify/1.0",
			},
		}
		...
		// 设置User-Agent
		req.Header.Set("User-Agent", "heqiuyu-Bark-Notify/1.0")
	...
	if system_setting.EnableWorker() {
		...
		workerReq := &WorkerRequest{
			...
			Headers: map[string]string{
				...
				"User-Agent":   "heqiuyu-Gotify-Notify/1.0",
			},
			Body: payloadBytes,
		}
		...
		req.Header.Set("User-Agent", "heqiuyu-Gotify-Notify/1.0")
