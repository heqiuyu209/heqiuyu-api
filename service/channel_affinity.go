...
const (
	...
	channelAffinityCacheNamespace           = "heqiuyu-api:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "heqiuyu-api:channel_affinity_usage_cache_stats:v1"
)
