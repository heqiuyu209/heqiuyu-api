...
func HasCSAMViolationMarker(err *types.HeqiuyuError) bool {
	if err == nil {
		return false
	}
...
func WrapAsViolationFeeGrokCSAM(err *types.HeqiuyuError) *types.HeqiuyuError {
	if err == nil {
		return nil
	}
...
func NormalizeViolationFeeError(err *types.HeqiuyuError) *types.HeqiuyuError {
	if err == nil {
		return nil
	}
...
func shouldChargeViolationFee(err *types.HeqiuyuError) bool {
	if err == nil {
		return false
	}
...
func ChargeViolationFeeIfNeeded(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, apiErr *types.HeqiuyuError) bool {
